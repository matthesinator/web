    ...
    <div class="page">
        ...
        <div class="content-container">
            ...
            <nav class="contentnav">
                    <ul>
                        <li><a href="#grundlagen">1 Grundlagen</a></li>
                        <li><a href="#aufbau">2 Aufbau von CSS-Dokumenten</a></li>
                        <li><a href="#box-modell">3 Das Box-Modell</a></li>
                        <li><a href="#text-formatierung">4 Text und Textformatierung</a></li>
                        <hr>
